# Build Order — Penova v0.1 (Swift / SwiftUI)
...
- [ ] `PenovaButton` (primary / secondary / ghost / destructive variants)
- [ ] `PenovaTag` (capsule with paper bg, labelTiny caps text)
- [ ] `PenovaChip` (selectable filter)
- [ ] `PenovaTextField` (with label + error state)
- [ ] `PenovaSectionHeader` (uppercase labelCaps + divider)
