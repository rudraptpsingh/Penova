...
//  Penova
//
//  Single source of truth for the Penova design system.
//  Extracted from Figma file: Penova — iOS App Design (page "01 · Tokens").
...
public enum PenovaFont {
    ...
    // Brand display — Playfair Display for Penova wordmark / icon mark.
