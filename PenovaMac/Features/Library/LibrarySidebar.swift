...
struct LibrarySidebar: View {
        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                LazyVStack(alignment: .leading, spacing: 0) {
                    // Smart groups
                    sectionHeader("Smart")
                    smartRow(label: "All Scenes",     systemImage: "rectangle.stack",
                             count: allScenes.count, isActive: false)
                    smartRow(label: "Bookmarked",     systemImage: "bookmark",
                             count: bookmarkedCount, isActive: false)
                    smartRow(label: "Recently Edited", systemImage: "clock",
                             count: min(8, allScenes.count), isActive: false)
    ...
    private func smartRow(label: String, systemImage: String, count: Int, isActive: Bool) -> some View {
        HStack(spacing: 8) {
