...
//  All icons are 24×24, 1.5pt stroke, stroke colour `DraftrColor.snow`.
//
...
public enum DraftrIcon: CaseIterable {
...
public struct DraftrIconView: View {
    public let icon: DraftrIcon
    public var size: CGFloat = 24
    public var color: Color = DraftrColor.snow
    public var weight: Font.Weight = .regular     // SF Symbols weight

    public init(_ icon: DraftrIcon,
                size: CGFloat = 24,
                color: Color = DraftrColor.snow,
