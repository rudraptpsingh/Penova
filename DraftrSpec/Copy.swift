...
public enum Copy {
    ...
    // MARK: Paywall
    public enum paywall {
        public static let badge = "Draftr Pro"
        ...
        public static let subtitle           = "You get Draftr free for one project. When your stories outgrow that, Pro is here."
        ...
        public static let footnote           = "No trial. Start free. Upgrade only when Draftr has earned it. Cancel anytime in Settings."
    ...
    public enum settings {
        ...
        public static let proPlanLabel      = "Draftr Pro"
    ...
    // MARK: Errors
    public enum errors {
        public static let offlineBanner   = "You're offline. Draftr is saving locally — will sync when you reconnect."
    ...
    public enum emptyStates {
        ...
        public static let homeBody  = "Create a project. Draftr will keep the formatting out of your way."
